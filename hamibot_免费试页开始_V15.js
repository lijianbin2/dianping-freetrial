// V15 2026-09-13 minimal: 手动进入免费试列表页后开始,不再找首页入口. 起手ensureMeishi,严校验.
auto.waitFor();
...
function ensureMeishi(){
  ...
  for(var r=0;r<3;r++){
    ...
    try{list.sort(function(x,y){return x.bounds().centerY()-y.bounds().centerY();});}catch(e){}
